...
V0 = 5;
Initial_alpha = pi/4
Vx0 = V0*cos(Initial_alpha )
Vy0 = V0*sin(Initial_alpha)
...
a0y = F0y/m
    % first moVement
x1 = e_position_x0 + Vx0*t + 0.5*a0x*t.^2 
y1 = e_position_y0 + Vy0*t + 0.5*a0y*t.^2
...
r1_Vector = [Ion_position_x0,Ion_position_y0] - [x1,x2];
r1 = norm(r1_Vector);
